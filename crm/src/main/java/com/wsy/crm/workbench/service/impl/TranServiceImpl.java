...
import com.wsy.crm.workbench.mapper.TranMapper;
...
public class TranServiceImpl implements TranService {
    ...
    public void saveCreateTran(Map<String, Object> map) {
        ...
        //调用客户的mapper，看看这笔交易的客户在客户表中是否存在

        Customer customer = customerMapper.selectCustomerByName(customerName);
        if(customer == null){
            //如果客户不存在，需要在客户表中新建一个客户保存记录
        ...
        tran.setCreateBy(DateUtils.formatDateTime(new Date()));
