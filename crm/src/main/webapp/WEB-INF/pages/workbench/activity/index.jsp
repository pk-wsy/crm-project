	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#editActivityBtn").click(function () {
				...
				//业务逻辑规定，修改的时候只能保证一个框框被选中
				//判断是否有记录被选中，或者选中的框数是否超过一个，不符则给予友好提示并返回
				if(chkedIds.size()==0){
					alert("请选择要修改的市场活动");
					return;
				}
				...
				$.ajax({
					...
					success:function (data) {
						//把市场活动的信息显示在修改的模态窗口上
						$("#edit-id").val(data.id);
						//data.owner是用户的id，把id赋值给下拉框option的val值，使得option根据id可以在模态窗口上显示用户的name
		...
		/*
		* 封装在函数中，多次进行复用，供之后进行调用
		* 注意，函数的定义应该在入口函数之外，他们是平级关系
		* */
			...
			<div class="modal-body">
				...
				<form id="createActivityForm" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-marketActivityOwner">
								<%--jstl标签库循环遍历后台传过来的所有用户，依次展示在选项中--%>
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 300px;">
                            <%--创建容器（日历插件的容器），在入口函数处对该容器调用插件的函数，给此处添加上日历--%>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					<%--设置隐藏域，保存用户的id，用于修改操作中，在确认修改时可以根据id参数去修改相关信息
						（必须根据id修改，因为id具有唯一标识性，而前端又不直接展示id，故将其放在隐藏域中）--%>
