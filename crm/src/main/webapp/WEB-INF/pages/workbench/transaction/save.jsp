...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="hidden" id="create-activityId" value="2cf44bacd64041a59881fe313d3065de">
			<input type="text" class="form-control" id="create-activityName" value="测试01_1">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10" style="width: 300px;">
			<input type="hidden" id="create-contactsId" value="30d1b8cdd06a4ad7b2cb284272adc8ff">
			<input type="text" class="form-control" id="create-contactsName" value="王释一">
		</div>
	</div>
